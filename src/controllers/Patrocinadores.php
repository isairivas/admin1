...
/**
 * Description of Patrocinadores
 *
 * @author isai
 */
class Patrocinadores extends Controller {
    private $_name = 'patrocinadores';
    private $_table ='patrocinadores';
    private $_uploads;
    
    function __construct() {
        parent::__construct();
        Param::setMenu('catalogos');
        Param::setSubMenu('patrocinadores');
        Param::setTitle('Patrocinadores');
    ...
    public function index()
    {
       ...
       Param::navigate(array('Home' => 'index.php','Patrocinadores' => go($this->_name)), 'icon-database');
    ...
    public function nuevo(){
        ...
        Param::navigate(array('Home' => 'index.php','Patrocinadores' => go($this->_name),'Nuevo' => go($this->_name,'nuevo')), 'icon-database');
        Param::setTitle('Agregar nuevo patrocinador');
    ...
    public function agregar(){
        ...
        $dataUpdate['nombre_es'] = parent::getPost('registro.nombre_es', Filter::STRING, TRUE);
     ...
     public function edit($intId = 0){
        ...
        Param::setTitle('Editar Patrocinador');
