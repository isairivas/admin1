 ...
 * @author isai
 */
class EventoPatrocinadores extends Controller {
    
    private $_name = 'evento-patrocinadores';
    private $_table ='evento_patrocinadores';
    private $_uploads;
    private $_primary = 'id';
    private $_title = 'Patrocinadores';
    ...
    function __construct() {
        ...
        $this->_uploads = PATH_UPLOADS.'images/eventos_patrocinadores/';
    ...
    public function index()
    {
       ...
       $aData = array(
        ...
        parent::getLoad()->loadView('eventos_patrocinadores/index',$aData);
    ...
    public function nuevo($eventoId = 'error') {
       ...
       $evento = $eventosDB->getById($eventoId);
        ...
        Param::setTitle('Nuevo patrocinador');
        ...
        parent::getLoad()->loadView('containers/menu_sidebar');
        parent::getLoad()->loadView('containers/navigation');
        parent::getLoad()->loadView('eventos_patrocinadores/agregar',$aData);
