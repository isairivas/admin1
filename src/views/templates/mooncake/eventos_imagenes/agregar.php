            ...
            <div class="span12 widget">
                ...
                <div class="widget-content form-container">
                    <form class="form-horizontal" action="<?php echo $arrData['action']; ?>" method="post" enctype="multipart/form-data" >
                        <?php if(isset($registro['evento_imagen_id'])): ?>
                        <input type="hidden" name="registro[evento_imagen_id]" id="administrador_id" value="<?php echo $registro['evento_imagen_id']; ?>" />
                        <?php endif; ?>
                     ...
                     <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <div> <img src="<?php echo HOME.'../uploads/images/eventos_imagenes/thumb_admin_'.$registro['imagen']; ?>" /></div>
                                <?php endif; ?>
