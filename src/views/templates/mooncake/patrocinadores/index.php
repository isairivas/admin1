    ...
    <div class="widget-content table-container">
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo $item['nombre_es']; ?></td>
                    <td>
                        <?php if(file_exists('../uploads/images/patrocinadores/thumb_admin_'.$item['imagen'])): ?>
                        <img style="width: 60px;height: 60px;" src="../uploads/images/patrocinadores/thumb_admin_<?php echo $item['imagen']; ?>" />
                        <?php endif ?>
                    </td>
                    <td>
